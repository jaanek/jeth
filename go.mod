...
require (
	...
	github.com/ledgerwatch/erigon v1.9.7-0.20210905085335-ac086830fec1 // indirect
	github.com/ledgerwatch/erigon-lib v0.0.0-20210903061352-2c1e2b0ec467 // indirect
